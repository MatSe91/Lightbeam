...
Der Einfallende Strahl repräsentiert den Lichtstrahl, der auf den Spiegel trifft. Der Reflektierende Strahl repräsentiert den Lichtstrahl, wie er vom Spiegel zurück geworfen wird. Das Einfallslot ist eine Hilfslinie, die senkrecht auf der Spiegelfläche, im Auftreffpunkt des Lichtstrahls liegt. Das Einfallslot kann als eine Art Zeiger betrachtet werden, da sie bei jeder Verdrehung des Spiegels eine andere Richtung einschlägt und somit die Lage des Spiegels charakterisiert. Der Einfallswinkel ist der Winkel zwischen dem einfallenden Lichtstrahl und dem Einfallslot. Der Reflexionswinkel ist der Winkel zwischen dem Lot und dem reflektiertem Strahl.
\TODO{Aus dem Buch Seite 198-199)}

Daraus folgt, dass der reflektierte Lichtstrahl genau den gleichen Winkel aufweist wie der einfallende Lichtstrahl. 
